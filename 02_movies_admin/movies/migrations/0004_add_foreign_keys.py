# Generated by Django 3.2 on 2022-04-11 12:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("movies", "0003_change_fields_nullability"),
    ]

    operations = [
        migrations.RunSQL(
            sql="""ALTER TABLE content.genre_film_work ADD CONSTRAINT genre_film_work_fk_film_work_id FOREIGN KEY (film_work_id) REFERENCES content.film_work(id) DEFERRABLE INITIALLY DEFERRED; 
                ...
                """,
            reverse_sql="""ALTER TABLE content.genre_film_work DROP CONSTRAINT genre_film_work_fk_film_work_id;
                ALTER TABLE content.genre_film_work DROP CONSTRAINT genre_film_work_fk_genre_id;
                ALTER TABLE content.person_film_work DROP CONSTRAINT person_film_work_fk_film_work_id;
                ALTER TABLE content.person_film_work DROP CONSTRAINT person_film_work_fk_person_id;""",
        )
    ]
